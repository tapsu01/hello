                            ...
                            <ul>
                                <li class="text-field span3">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input type="text" name="yit_contact[name]" id="name-contact-form" class="icon error required formRed" value="" />

                                    </div>
                                    <div class="msg-error">Insert the name</div>
                                    <div class="clear"></div>
                                </li>
                                ...
                                <li class="text-field span3">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input type="text" name="yit_contact[email]" id="email-contact-form" class="icon error required formRed" value="" />
                                    </div>

                                    <div class="msg-error">Insert a valid email</div>
                                    <div class="clear"></div>
                                </li>
                                ...
                                <li class="textarea-field span9">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <textarea name="yit_contact[message]" id="message-contact-form" rows="8" cols="30" class="icon error required formRed"></textarea>
                                    </div>
                                    <div class="msg-error">Insert a message</div>
